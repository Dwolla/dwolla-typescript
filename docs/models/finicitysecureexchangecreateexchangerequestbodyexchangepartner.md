...
```typescript
import { FinicitySecureExchangeCreateExchangeRequestBodyExchangePartner } from "dwolla-typescript";

let value: FinicitySecureExchangeCreateExchangeRequestBodyExchangePartner = {
  href:
