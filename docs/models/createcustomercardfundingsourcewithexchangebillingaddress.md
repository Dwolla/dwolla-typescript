...
```typescript
import { CreateCustomerCardFundingSourceWithExchangeBillingAddress } from "dwolla/models";

let value: CreateCustomerCardFundingSourceWithExchangeBillingAddress = {
