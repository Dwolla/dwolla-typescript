...
```typescript
import { MXSecureExchangeCreateExchangeRequestBodyExchangePartner } from "dwolla-typescript";

let value: MXSecureExchangeCreateExchangeRequestBodyExchangePartner = {
  href:
