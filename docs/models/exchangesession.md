...
| `externalProviderSessionData`                                                                                                                                  | [models.ExternalProviderSessionData](../models/externalprovidersessiondata.md)                                                                                 | :heavy_minus_sign:                                                                                                                                             | Present for Checkout.com exchange sessions (Push to Card / debit card flow).<br/>Use these fields to initialize the Checkout.com Flow component for card capture.<br/> |                                                                                                                                                                |