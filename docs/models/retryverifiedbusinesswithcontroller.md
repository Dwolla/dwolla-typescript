...
```typescript
import { RetryVerifiedBusinessWithController } from "dwolla/models";

let value: RetryVerifiedBusinessWithController = {
  firstName: "Account",
  lastName: "Admin",
...
| `controller`                                                                                                       | [models.RetryVerifiedBusinessWithControllerController](../models/retryverifiedbusinesswithcontrollercontroller.md) | :heavy_check_mark:                                                                                                 | N/A                                                                                                                |                                                                                                                    |
