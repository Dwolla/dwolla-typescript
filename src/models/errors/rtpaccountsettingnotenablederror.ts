...
export type RtpAccountSettingNotEnabledErrorData = {
  code: string;
  message: string;
};

export class RtpAccountSettingNotEnabledError extends Error {
  code: string;

  /** The original data that was passed to this error instance. */
  data$: RtpAccountSettingNotEnabledErrorData;

  constructor(err: RtpAccountSettingNotEnabledErrorData) {
    ...
    this.name = "RtpAccountSettingNotEnabledError";
  }
}
...
> = z.object({
  ...
  .transform((v) => {
    return new RtpAccountSettingNotEnabledError(v);
  });
