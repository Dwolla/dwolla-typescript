 ...
 * not found
 */
export class ListFundingSourcesNotFoundDwollaV1HalJSONError extends Error {
  code?: string | undefined;

  /** The original data that was passed to this error instance. */
  data$: ListFundingSourcesNotFoundDwollaV1HalJSONErrorData;

  constructor(err: ListFundingSourcesNotFoundDwollaV1HalJSONErrorData) {
 ...
 * forbidden
 */
export class ListFundingSourcesForbiddenDwollaV1HalJSONError extends Error {
  code?: string | undefined;

  /** The original data that was passed to this error instance. */
  data$: ListFundingSourcesForbiddenDwollaV1HalJSONErrorData;

  constructor(err: ListFundingSourcesForbiddenDwollaV1HalJSONErrorData) {
    const message = "message" in err && typeof err.message === "string"
      ? err.message
      : `API error occurred: ${JSON.stringify(err)}`;
    super(message);
