...
export function massPaymentsCreate(
  ...
  Result<
    operations.InitiateMassPaymentResponse | undefined,
    | errors.BadRequestError
    | errors.InitiateMassPaymentDwollaV1HalJSONError
    | DwollaError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.InitiateMassPaymentRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/mass-payments")();
  ...
  >(
    M.nil(
      201,
      operations.InitiateMassPaymentResponse$inboundSchema.optional(),
      { hdrs: true },
    ),
    ...
    M.jsonErr(
      403,
      errors.InitiateMassPaymentDwollaV1HalJSONError$inboundSchema,
      { ctype: "application/vnd.dwolla.v1.hal+json" },
    ),
    M.fail("4XX"),
    M.fail("5XX"),
