...
export function accountsFundingSourcesCreate(
  ...
  Result<
    operations.CreateFundingSourceResponse | undefined,
    | errors.CreateFundingSourceDwollaV1HalJSON
    | errors.CreateFundingSourceDwollaV1HalJSONError
    | DwollaError
...
> {
  ...
  >(
    M.nil(
      201,
      operations.CreateFundingSourceResponse$inboundSchema.optional(),
      { hdrs: true },
    ),
    M.jsonErr(400, errors.CreateFundingSourceDwollaV1HalJSON$inboundSchema, {
      ctype: "application/vnd.dwolla.v1.hal+json",
    }),
    M.jsonErr(
      403,
      errors.CreateFundingSourceDwollaV1HalJSONError$inboundSchema,
      { ctype: "application/vnd.dwolla.v1.hal+json" },
    ),
    M.fail("4XX"),
    M.fail("5XX"),
