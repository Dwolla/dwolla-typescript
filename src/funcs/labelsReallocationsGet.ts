...
export function labelsReallocationsGet(
  ...
  Result<
    operations.RetrieveLabelReallocationResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.RetrieveLabelReallocationRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/label-reallocations/{reallocationId}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.RetrieveLabelReallocationResponse$inboundSchema, {
