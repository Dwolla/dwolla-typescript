 ...
 */
export function exchangesCreateAccountExchange(
  client: DwollaCore,
  request: operations.CreateAccountExchangeRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.CreateAccountExchangeResponse,
    | errors.CreateAccountExchangeDwollaV1HalJSON
    | errors.CreateAccountExchangeDwollaV1HalJSONError
    | APIError
    | SDKValidationError
    | UnexpectedClientError
    | InvalidRequestError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.CreateAccountExchangeRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(201, operations.CreateAccountExchangeResponse$inboundSchema, {
      ctype: "application/vnd.dwolla.v1.hal+json",
      hdrs: true,
      key: "Result",
    }),
    M.jsonErr(400, errors.CreateAccountExchangeDwollaV1HalJSON$inboundSchema, {
      ctype: "application/vnd.dwolla.v1.hal+json",
    }),
    M.jsonErr(
      401,
      errors.CreateAccountExchangeDwollaV1HalJSONError$inboundSchema,
      { ctype: "application/vnd.dwolla.v1.hal+json" },
    ),
    M.fail("4XX"),
    M.fail("5XX"),
