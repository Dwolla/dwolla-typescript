 ...
 */
export function fundingSourcesMicroDepositsInitiate(
  client: DwollaCore,
  ...
  Result<
    ...
    | errors.InitiateMicroDepositsForbiddenDwollaV1HalJSONError
    | errors.InitiateMicroDepositsNotFoundDwollaV1HalJSONError
    | DwollaError
...
> {
  ...
  const path = pathToFunc("/funding-sources/{id}/micro-deposits#initiate")(
    pathParams,
  );
  ...
  >(
    ...
    M.jsonErr(
      403,
      errors.InitiateMicroDepositsForbiddenDwollaV1HalJSONError$inboundSchema,
      { ctype: "application/vnd.dwolla.v1.hal+json" },
    ),
    M.jsonErr(
      404,
      errors.InitiateMicroDepositsNotFoundDwollaV1HalJSONError$inboundSchema,
      { ctype: "application/vnd.dwolla.v1.hal+json" },
    ),
    M.fail("4XX"),
    M.fail("5XX"),
