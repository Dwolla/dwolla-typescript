 ...
 */
export function fundingSourcesOnDemandTransferAuthorizationsCreate(
  client: DwollaCore,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.OnDemandAuthorization,
...
> {
  const path = pathToFunc("/on-demand-authorizations")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.OnDemandAuthorization$inboundSchema, {
