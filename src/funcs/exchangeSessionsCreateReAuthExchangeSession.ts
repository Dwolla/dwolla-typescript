 ...
 */
export function exchangeSessionsCreateReAuthExchangeSession(
  client: DwollaCore,
  request: operations.CreateReAuthExchangeSessionRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.CreateReAuthExchangeSessionResponse | undefined,
    | errors.CreateReAuthExchangeSessionBadRequestDwollaV1HalJSONError
    | errors.CreateReAuthExchangeSessionForbiddenDwollaV1HalJSONError
    | APIError
    | SDKValidationError
    | UnexpectedClientError
    | InvalidRequestError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.CreateReAuthExchangeSessionRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/exchanges/{id}/exchange-sessions")(pathParams);
  ...
  >(
    M.nil(
      201,
      operations.CreateReAuthExchangeSessionResponse$inboundSchema.optional(),
      { hdrs: true },
    ),
    M.jsonErr(
      400,
