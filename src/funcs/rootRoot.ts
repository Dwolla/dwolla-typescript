 ...
 */
export function rootRoot(
  client: DwollaCore,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.Root,
    | errors.RootDwollaV1HalJSONError
    | APIError
    | SDKValidationError
    | UnexpectedClientError
    | InvalidRequestError
...
> {
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, models.Root$inboundSchema, {
      ctype: "application/vnd.dwolla.v1.hal+json",
    }),
    M.jsonErr(401, errors.RootDwollaV1HalJSONError$inboundSchema, {
      ctype: "application/vnd.dwolla.v1.hal+json",
    }),
    M.fail("4XX"),
    M.fail("5XX"),
