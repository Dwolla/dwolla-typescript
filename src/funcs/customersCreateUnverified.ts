 ...
 */
export function customersCreateUnverified(
  client: DwollaCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => models.CreateUnverifiedCustomer$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/customers#unverified")();
  ...
  >(
    M.nil(
      201,
      operations.CreateUnverifiedCustomerResponse$inboundSchema.optional(),
      { hdrs: true },
    ),
