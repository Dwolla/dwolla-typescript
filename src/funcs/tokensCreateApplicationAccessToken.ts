...
export function tokensCreateApplicationAccessToken(
  ...
  Result<
    operations.CreateApplicationAccessTokenResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.CreateApplicationAccessTokenRequest$outboundSchema.parse(
        value,
      ),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.CreateApplicationAccessTokenResponse$inboundSchema),
