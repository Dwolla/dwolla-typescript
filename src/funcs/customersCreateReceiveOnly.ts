 ...
 */
export function customersCreateReceiveOnly(
  client: DwollaCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => models.CreateReceiveOnlyUser$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/customers#receive-only")();
  ...
  >(
    M.nil(
      201,
      operations.CreateReceiveOnlyCustomerResponse$inboundSchema.optional(),
      { hdrs: true },
    ),
