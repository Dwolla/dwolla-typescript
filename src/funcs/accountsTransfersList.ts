...
export function accountsTransfersList(
  ...
  Result<
    models.Transfers,
    | errors.ListAndSearchTransfersDwollaV1HalJSONError
    | DwollaError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListAndSearchTransfersRequest$outboundSchema.parse(value),
  ...
  >(
    ...
    M.jsonErr(
      404,
      errors.ListAndSearchTransfersDwollaV1HalJSONError$inboundSchema,
      { ctype: "application/vnd.dwolla.v1.hal+json" },
    ),
    M.fail("4XX"),
    M.fail("5XX"),
