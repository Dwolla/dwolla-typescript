 ...
 */
export function exchangeSessionsListAvailableExchangeConnections(
  client: DwollaCore,
  request: operations.ListAvailableExchangeConnectionsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.AvailableExchangeConnections,
    | errors.ListAvailableExchangeConnectionsDwollaV1HalJSONError
    | APIError
    | SDKValidationError
    | UnexpectedClientError
    | InvalidRequestError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListAvailableExchangeConnectionsRequest$outboundSchema.parse(
        value,
      ),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, models.AvailableExchangeConnections$inboundSchema, {
      ctype: "application/vnd.dwolla.v1.hal+json",
    }),
    M.jsonErr(
      404,
      errors.ListAvailableExchangeConnectionsDwollaV1HalJSONError$inboundSchema,
      { ctype: "application/vnd.dwolla.v1.hal+json" },
    ),
    M.fail("4XX"),
    M.fail("5XX"),
