 ...
 */
export function exchangesCreateCustomerExchange(
  client: DwollaCore,
  ...
  Result<
    ...
    | errors.CreateCustomerExchangeBadRequestDwollaV1HalJSONError
    | errors.CreateCustomerExchangeUnauthorizedDwollaV1HalJSONError
    | errors.CreateCustomerExchangeNotFoundDwollaV1HalJSONError
    | APIError
    | SDKValidationError
    | UnexpectedClientError
    | InvalidRequestError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.CreateCustomerExchangeRequest$outboundSchema.parse(value),
  ...
  >(
    ...
    M.jsonErr(
      400,
      errors.CreateCustomerExchangeBadRequestDwollaV1HalJSONError$inboundSchema,
    ...
    M.jsonErr(
      404,
      errors.CreateCustomerExchangeNotFoundDwollaV1HalJSONError$inboundSchema,
      { ctype: "application/vnd.dwolla.v1.hal+json" },
    ),
    M.fail("4XX"),
    M.fail("5XX"),
