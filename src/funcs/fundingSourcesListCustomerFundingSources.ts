 ...
 * List customer funding sources
 */
export function fundingSourcesListCustomerFundingSources(
  client: DwollaCore,
  request: operations.ListCustomerFundingSourcesRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    Array<models.FundingSources>,
    | errors.ListCustomerFundingSourcesForbiddenDwollaV1HalJSONError
    | errors.ListCustomerFundingSourcesNotFoundDwollaV1HalJSONError
    | APIError
    | SDKValidationError
    | UnexpectedClientError
    | InvalidRequestError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListCustomerFundingSourcesRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, z.array(models.FundingSources$inboundSchema), {
