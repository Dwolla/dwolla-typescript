...
export function massPaymentsUpdate(
  ...
  Result<
    ...
    | errors.UpdateMassPaymentForbiddenDwollaV1HalJSONError
    | errors.UpdateMassPaymentNotFoundDwollaV1HalJSONError
    | APIError
    | SDKValidationError
    | UnexpectedClientError
    | InvalidRequestError
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.UpdateMassPaymentRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/mass-payments/{id}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, models.MassPayment$inboundSchema, {
    ...
    M.jsonErr(
      403,
      errors.UpdateMassPaymentForbiddenDwollaV1HalJSONError$inboundSchema,
      { ctype: "application/vnd.dwolla.v1.hal+json" },
    ),
    M.jsonErr(
      404,
      errors.UpdateMassPaymentNotFoundDwollaV1HalJSONError$inboundSchema,
      { ctype: "application/vnd.dwolla.v1.hal+json" },
    ),
    M.fail("4XX"),
    M.fail("5XX"),
