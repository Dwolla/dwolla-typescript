 ...
 */
export function customersListAndSearchCustomers(
  client: DwollaCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListAndSearchCustomersRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, models.Customers$inboundSchema, {
