 ...
 * List and search transfers for a customer
 */
export function transfersListCustomerTransfers(
  client: DwollaCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListCustomerTransfersRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/customers/{id}/transfers")(pathParams);
