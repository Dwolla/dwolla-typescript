...
export function fundingSourcesGetVanRouting(
  ...
  Result<
    operations.GetVanRoutingResponse,
    | errors.GetVanRoutingDwollaV1HalJSONError
    | DwollaError
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetVanRoutingRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetVanRoutingResponse$inboundSchema, {
      ctype: "application/vnd.dwolla.v1.hal+json",
    }),
    M.jsonErr(404, errors.GetVanRoutingDwollaV1HalJSONError$inboundSchema, {
      ctype: "application/vnd.dwolla.v1.hal+json",
    }),
    M.fail("4XX"),
    M.fail("5XX"),
