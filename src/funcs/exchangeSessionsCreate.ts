 ...
 */
export function exchangeSessionsCreate(
  client: DwollaCore,
  ...
  Result<
    ...
    | errors.CreateCustomerExchangeSessionDwollaV1HalJSONError
...
> {
  ...
  >(
    ...
    M.jsonErr(
      401,
      errors.CreateCustomerExchangeSessionDwollaV1HalJSONError$inboundSchema,
      { ctype: "application/vnd.dwolla.v1.hal+json" },
    ),
    M.jsonErr(
      403,
